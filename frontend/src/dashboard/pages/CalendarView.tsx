  ...
  return (
    <div style={{ height: '500px', padding: '10px', backgroundColor: '#1f2937' }}>
      <Calendar
        ...
        dayPropGetter={(date) => {
          const isCurrentMonth = moment(date).month() === moment(currentDate).month();
        ...
        components={{
          dateCellWrapper: ({ children, value }) => {
            const isCurrentMonth = moment(value).month() === moment(currentDate).month();
              ...
              <span className="rbc-btn-group">
                <button
                  ...
                  style={{
                    ...
                    backgroundColor: props.view === 'month' ? 'white' : 'transparent',
                  }}
                >
                  Month
                </button>
                <button
                  ...
                  style={{
                    ...
                    backgroundColor: props.view === 'week' ? 'white' : 'transparent',
                  }}
                >
                  Week
                </button>
                ...
                <button
                  ...
                  className={`rbc-btn ${props.view === 'agenda' ? 'rbc-active' : ''}`}
                  style={{
                    color: props.view === 'agenda' ? '#1f2937' : 'white',
                    backgroundColor: props.view === 'agenda' ? 'white' : 'transparent',
                  }}
                >
                  Agenda
                </button>
