    ...
    },
    {
      ...
      details: (
        <div className="text-blue-800 leading-snug">
          <span className="font-semibold">CoSpace:</span>
          <br />
          Str. Enver Maloku, No.10
          <br />
          Prishtinë, 10000, RKS
        </div>
      ),
          ...
          <div className="flex flex-col gap-10 w-full md:w-1/3 relative z-10">
            {contactCards.map((item, i) => (
              <div
                key={i}
                onClick={() =>
                  (item.isMap || item.isEmail) && handleClick(item)
                }
      ...
      <section id="map-section" className="py-16 bg-blue-50">
        <div className="container mx-auto px-6 max-w-6xl text-center">
          ...
          <p className="text-lg text-blue-800 mb-12 max-w-2xl mx-auto">
            Come explore CoSpace and find the environment that suits your
            ambition. Navigate our world through the map below.
          </p>
