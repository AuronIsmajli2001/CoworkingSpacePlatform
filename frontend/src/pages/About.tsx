...
import { Sparkles, Users, Heart, Coffee, Home, MapPin, Phone, CreditCard, Mail, Facebook, Wallet, Instagram, Twitter, Youtube, Linkedin } from 'lucide-react';
      ...
      <section className="py-28 bg-white">
        <div className="container mx-auto px-6 text-center max-w-3xl">
          ...
          <p className="text-xl text-gray-600 leading-relaxed">
            A space worth leaving home for. Professional yet welcoming. 
            Designed for productivity but built for connection.
          </p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <div className="flex items-center gap-3 mb-6">
                ...
                <span className="text-sm font-medium text-gray-500">OUR STORY</span>
              </div>
              ...
              <div className="space-y-4 text-gray-600">
                <p>
                  CoSpace was born from countless hours in coffee shops and home offices - 
                  never quite finding that sweet spot between professional and personal.
                </p>
                <p>
                  We designed a space that celebrates work as part of life, not separate from it. 
                  Where productivity meets community, and every detail serves your needs.
                </p>
                <p>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-6 max-w-5xl text-center">
          <h2 className="text-3xl font-bold text-gray-900 mb-12">
            <span className="text-blue-600">Co</span>mmunity • <span className="text-blue-600">Space</span> • <span className="text-blue-600">Balance</span>
          </h2>
